...
namespace ukt4dotnet.shared.utilities.IO.Paths
{
    public static class MainModule
    {
        ...
        public static string OSPathToNormalizedPath(String APath)
        {
            ...
            Result = ukt4dotnet.shared.utilities.StrUtils.ReplaceCopy(APath, @"/", @"\");

            // add
            int ALen = (Result.Length - 1);
            Result =
                ukt4dotnet.shared.utilities.strings.StrUtils.FirstCharCopy(Result) + ":" +
                ukt4dotnet.shared.utilities.strings.StrUtils.RightCopyByLength(Result, ALen);

            Result = ukt4dotnet.shared.utilities.StrUtils.TrimPrefix("^/", Result);
