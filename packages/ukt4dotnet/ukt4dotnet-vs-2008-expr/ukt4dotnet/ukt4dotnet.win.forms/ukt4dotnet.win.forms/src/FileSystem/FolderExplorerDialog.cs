    ...
    public partial class FolderExplorerDialog : Form
    {
        ...
        protected void LoadSpecialFoldersListview()
        {
            ...
            String MyDocumentsNormalizedPath =
                ukt4dotnet.shared.utilities.IO.Paths.MainModule.OSPathToNormalizedPath(MyDocumentsOSPath);
            ...
            String MyDesktopNormalizedPath =
                ukt4dotnet.shared.utilities.IO.Paths.MainModule.OSPathToNormalizedPath(MyDesktopOSPath);
        ...
        protected void selectOnlyFiles()
        {
            ...
            if (CanSelect)
            {
                ...
                if (thisItem.IsFolder)
                {
                    ...
                    this.SelectedPath =
                        ukt4dotnet.shared.utilities.IO.Paths.MainModule.NormalizedPathToOSPath(NormalizedPath);
                ...
                else
                {
                    ...
                    ukt4dotnet.win.forms.MessageBoxes.ErrorBox.ShowTitle(ErrMsg, ErrTitle);
                }
            }
            else
            {
        ...
        private void SpecialFoldersListView_Click(object sender, EventArgs e)
        {
            ...
            String thisOSPath =
                ukt4dotnet.shared.utilities.IO.Paths.MainModule.NormalizedPathToOSPath(thisNormalizedPath);
        ...
        private void NewFolderToolStripButton_Click(object sender, EventArgs e)
        {
            ...
            if (thisParentTreeNode == this.RootNode)
            {
                ...
                ukt4dotnet.win.forms.MessageBoxes.ErrorBox.ShowTitle(errMsg1, errTitle1);
            }
            else
            {
                ...
                bool Captured = ukt4dotnet.win.forms.InputBoxes.InputBox.ShowLen
                ...
                if (Captured)
                {
                    ...
                    String OSPath = ukt4dotnet.shared.utilities.IO.Paths.MainModule.NormalizedPathToOSPath(NormalizedPath);
                    ...
                    if (IsDuplicated)
                    {
                        ...
                        ukt4dotnet.win.forms.MessageBoxes.ErrorBox.ShowTitle(errMsg2, errTitle2);
                    }
                    else
                    {
                        try
        ...
        private void DeleteFolderToolStripButton_Click(object sender, EventArgs e)
        {
            ...
            if (thisTreeNode == this.RootNode)
            {
                ...
                ukt4dotnet.win.forms.MessageBoxes.ErrorBox.ShowTitle(errText1, errTitle1);
            }
            else
            {
                ...
                if (IsDriveFolder)
                {
                    ...
                    ukt4dotnet.win.forms.MessageBoxes.ErrorBox.ShowTitle(errText2, errTitle2);
                }
                else
                {
                    ...
                    bool ConfirmDeletion =
                      (ukt4dotnet.win.forms.MessageBoxes.ConfirmBox.Show(msgText, msgTitle) == System.Windows.Forms.DialogResult.Yes);
                    if (ConfirmDeletion)
                    {
                        ...
                        bool IsEmpty = ukt4dotnet.shared.utilities.IO.Paths.MainModule.IsEmpty(OSPath);
                        if (!IsEmpty)
                        {
                            String errText3 = "Folder is not empty";
                            String errTitle3 = "Delete selected Folder";
                            ukt4dotnet.win.forms.MessageBoxes.ErrorBox.ShowTitle(errText3, errTitle3);
                        }
                        else
                        {
                            try
