...
namespace ukt4dotnet.shared.utilities
{
    ...
    public class ARGB
    {
        ...
        public ARGB(Int16 value)
        {
            ...
            String tempStr = ukt4dotnet.shared.utilities.Hexadecimal.IntToHex(value);
        ...
        public override string ToString()
        {
            ...
            String A = ukt4dotnet.shared.utilities.Hexadecimal.IntToHex((short)Alpha);
            String R = ukt4dotnet.shared.utilities.Hexadecimal.IntToHex((short)Red);
            String B = ukt4dotnet.shared.utilities.Hexadecimal.IntToHex((short)Blue);
            String G = ukt4dotnet.shared.utilities.Hexadecimal.IntToHex((short)Green);
        ...
        public bool tryConvertToInt(out Int16 destination)
        {
            ...
            destination = (Int16)ukt4dotnet.shared.utilities.Hexadecimal.HexToInt(tempHex);
        ...
        public static bool isValidString(String value)
        {
            ...
            if (ukt4dotnet.shared.utilities.Hexadecimal.IsHexString(value))
            {
        ...
        public static bool tryARGBToInt(ARGB source, out Int16 destination)
        {
            ...
            {
                destination = (Int16)ukt4dotnet.shared.utilities.Hexadecimal.HexToInt(temp);
            }
        ...
        public static bool tryIntToARGB(Int16 source, out ARGB destination)
        {
            ...
            String temp = ukt4dotnet.shared.utilities.Hexadecimal.IntToHex(source);
        ...
        public static Color StringToColor(String value)
        {
            ...
            if (!String.IsNullOrEmpty(value)) {
                ...
                if (value.Length == 8) {
                    ...
                    if (ukt4dotnet.shared.utilities.Hexadecimal.IsHexString(value))
                    {
                        int N = ukt4dotnet.shared.utilities.Hexadecimal.HexToInt(value);
